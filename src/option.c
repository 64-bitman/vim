...
/*
 * Process the new 'wltimeoutlen' or 'wlrtimeoutlen' option value.
 */
    char *
did_set_wltimeout(optset_T *args)
{
    if (args->os_newval.number < 0)
    {
	*((long*)args->os_varp) = args->os_oldval.number;
