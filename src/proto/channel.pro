...
int channel_select_setup(int maxfd_in, void *rfds_in, void *wfds_in, struct timeval *tv, struct timeval **tvp, bool cs);
int channel_select_check(int ret_in, void *rfds_in, void *wfds_in, bool cs);
...
int channel_start_server(char_u *name);
void channel_stop_server(void);
int channel_server_send(char_u *name, char_u *str, char_u **result, char_u **receiver, int is_expr, int timeout, int silent);
int channel_server_read_reply(char_u *client, char_u **str, int timeout);
int channel_server_peek_reply(char_u *sender, char_u **str);
int channel_server_send_reply(char_u *client, char_u *str);
/* vim: set ft=c : */
